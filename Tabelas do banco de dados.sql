...
SELECT CONCAT('O empresário ' , nomeResp,' tem a empresa ' , nomeEm, ' e contem ' , qtdTanque , ' dispensers, com a data do registro no site ' , dtRegistro , '. Senha do registro ' , senha , '. Contado da empresa' , cdEmail, '') as 'Cadastro das Empresas' FROM usuario;
